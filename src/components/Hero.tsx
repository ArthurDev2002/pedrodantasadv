      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl opacity-0 animate-fade-in-up-delay-1 drop-shadow-md">
          ...
          <div className="relative mt-12 lg:mt-0 opacity-0 animate-fade-in-right-delay">
            <img 
              ...
              className="rounded-2xl shadow-2xl object-cover h-[400px] sm:h-[500px] lg:h-[600px] w-full bg-brand-navy-light"
